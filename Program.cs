...
// Camion scania2 = scania;

// scania.Color = Colors.Bleu;

// scania2.Color = Colors.Rouge;

// Console.WriteLine($"Couleur du camion ; {scania.Color}");
// Console.WriteLine($"Couleur du camion ; {scania2.Color}");
...
// Console.WriteLine($"Integer2 : {integer2}");
